...
public partial class CharacterShotState : State
{
	...
	{
		// Disattiva il raycast dopo lo sparo
		weaponManager.currentWeapon.rayCast3D.Enabled = false;

		// Cambia lo stato del personaggio tornando allo stato di mira
		characterNode.StateMachineNode.SwitchState<CharacterAimState>();

		// Assicurati di rimuovere il collegamento al Timeout per evitare che venga chiamato ripetutamente
		weaponManager.currentWeapon.reloadTimer.Timeout -= HandleShotTimeout;
	}
}
